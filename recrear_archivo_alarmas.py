# Script para recrear el archivo de alarmas de manera correcta
with open('src/alarmas.py', 'w', encoding='utf-8') as file:
...
class SistemaAlarmas:
    ...
    def _enviar_notificacion_email(self, destinatario, asunto, mensaje):
        ...
        try:
            ...
            return False
''')
print("Archivo alarmas.py recreado correctamente")
